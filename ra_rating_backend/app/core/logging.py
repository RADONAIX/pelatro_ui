...
JSON in production, colourised console in development. A request-id contextvar
is bound per request by middleware so every line of a rating run is traceable
